...
def generate_welcome_message(member):
    ...
    "Я здесь, чтобы напомнить, как плохо я играю. Надеюсь, ты покажешь себя лучше!",
    "Как новый член, ты должен знать, что мои навыки игры оставляют желать лучшего.",
    "В гильдии одно правило - не рассчитывай на мой боп",
    ...
    "Мне отказали во вступлении в статик вихрь. Но ты выглядишь посильнее!",
    ...
    "Я здесь, чтобы напомнить, что даже самые плохие игроки, как я, найдут здесь своё место."
    ])
    ...
    "Наш гм - могучий ураган. Я всегда впечатлен от его способностей. Сможешь так же?"
    ...
    return (
        ...
        "Если у тебя есть вопросы, обращайся к нашему главе гильдии, либо к зам ГМу/менеджеру!"
    )
